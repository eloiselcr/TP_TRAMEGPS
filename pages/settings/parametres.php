                ...
                <div class="card-body">
                  ...
                  <form method="post" class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="text" name="new_pseudo" class="form-control" id="new_pseudo" placeholder="Choissisez...">
                    </div>
                    <button type="submit" name="modifier_pseudo" class="btn btn-primary me-2">Envoyer</button>
                ...
                <div class="card-body">
                  ...
                  <form method="post" class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="password" name="new_mdp" class="form-control" id="new_mdp" placeholder="Choissisez...">
                    </div>
                    <button type="submit" name="modifier_mdp" class="btn btn-primary me-2">Envoyer</button>
                    <button class="btn btn-dark">Annuler</button>
                  </form>
